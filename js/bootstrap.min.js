    ...
    h = (function () {
      ...
      return (
        ...
        (n._getRootElement = function (t) {
          let n = a.getSelectorFromElement(t),
            i = !1;
          return (
        ...
        (n._removeElement = function (t) {
          ...
          if ((e(t).removeClass('show'), e(t).hasClass('fade'))) {
            const i = a.getTransitionDurationFromElement(t);
            e(t)
            ...
            if (o) {
              if ('radio' === o.type)
                if (o.checked && this._element.classList.contains('active'))
                  ...
                  const s = i.querySelector('.active');
      ...
      return (
        ...
        (n._getItemByDirection = function (t, e) {
          ...
          if (((i && 0 === o) || (n && o === s)) && !this._config.wrap)
            return e;
          const r = (o + ('prev' === t ? -1 : 1)) % this._items.length;
          return -1 === r
        ...
        (n._slide = function (t, n) {
          ...
          if (
            ...
            const f = e.Event('slid.bs.carousel', {
              relatedTarget: h,
              direction: s,
              from: c,
              to: u,
            ...
            if (e(this._element).hasClass('slide')) {
              ...
              const g = parseInt(h.getAttribute('data-interval'), 10);
              g
                ...
                : (this._config.interval =
                    this._config.defaultInterval || this._config.interval);
              const m = a.getTransitionDurationFromElement(l);
              e(l)
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            const r = 'string' == typeof n ? n : o.slide;
            if (
        ...
        (t._dataApiClickHandler = function (n) {
          ...
          if (i) {
            ...
            if (o && e(o).hasClass('carousel')) {
              const r = s({}, e(o).data(), e(this).data()),
        ...
        (n.show = function () {
          ...
          if (
            ...
            if ((e(this._element).trigger(s), !s.isDefaultPrevented())) {
              ...
              const l = 'scroll' + (r[0].toUpperCase() + r.slice(1)),
        ...
        (n.hide = function () {
          ...
          if (!this._isTransitioning && e(this._element).hasClass('show')) {
            ...
            if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
              ...
              this.setTransitioning(!0);
              this._element.style[i] = '';
              const c = a.getTransitionDurationFromElement(this._element);
              e(this._element)
                .one(a.TRANSITION_END, function () {
    ...
    I = (function () {
      ...
      return (
        ...
        (i._getPlacement = function () {
          let t = e(this._element.parentNode),
            n = 'bottom-start';
          return (
            t.hasClass('dropup')
        ...
        (t._clearMenus = function (n) {
          if (!n || (3 !== n.which && ('keyup' !== n.type || 9 === n.which)))
            for (
              ...
              const r = t._getParentFromElement(i[o]),
              ...
              if ((n && 'click' === n.type && (l.clickEvent = n), a)) {
                ...
                if (
                  ...
                  const h = e.Event('hide.bs.dropdown', l);
                  e(r).trigger(h),
      ...
      return (
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                const s = a.getTransitionDurationFromElement(this._element);
                e(this._element)
        ...
        (n._triggerBackdropTransition = function () {
          ...
          if ('static' === this._config.backdrop) {
            ...
            const o = a.getTransitionDurationFromElement(this._dialog);
        ...
        (n._showElement = function (t) {
          ...
          const s = e.Event('shown.bs.modal', { relatedTarget: t }),
            r = function () {
          ...
          if (i) {
            const l = a.getTransitionDurationFromElement(this._dialog);
        ...
        (n._showBackdrop = function (t) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              return;
            if (!i) return void t();
            const o = a.getTransitionDurationFromElement(this._backdrop);
            ...
            if (e(this._element).hasClass('fade')) {
              const r = a.getTransitionDurationFromElement(this._backdrop);
              e(this._backdrop)
    ...
    X = (function () {
      ...
      return (
        ...
        (i.show = function () {
          ...
          const i = e.Event(this.constructor.Event.SHOW);
          if (this.isWithContent() && this._isEnabled) {
            e(this.element).trigger(i);
            const o = a.findShadowRoot(this.element),
              s = e.contains(
            ...
            if (e(this.tip).hasClass('fade')) {
              const f = a.getTransitionDurationFromElement(this.tip);
        ...
        (i.hide = function (t) {
          ...
          if ((e(this.element).trigger(o), !o.isDefaultPrevented())) {
            if (
              ...
              const r = a.getTransitionDurationFromElement(i);
    ...
    rt = (function () {
      ...
      return (
        ...
        (n._activate = function (t) {
          ...
          const n = this._selector.split(',').map(function (e) {
              return (
      ...
      return (
        (n.show = function () {
          ...
          if (
            ...
            const l = e.Event('hide.bs.tab', { relatedTarget: this._element }),
        ...
        (n._activate = function (t, n, i) {
          ...
          if (s && r) {
            const c = a.getTransitionDurationFromElement(s);
            e(s)
              .removeClass('show')
        ...
        (n._transitionComplete = function (t, n, i) {
          ...
          if (
            ...
            const s = e(t).closest('.dropdown')[0];
            if (s) {
              const r = [].slice.call(s.querySelectorAll('.dropdown-toggle'));
              e(r).addClass('active');
            }
